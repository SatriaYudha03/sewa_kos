// lib/features/tenant_dashboard/screens/tenant_home_screen.dart
        ...
        child: _currentUser == null
            ...
            : Column(
                ...
                children: [
                  ...
                  // Di sini nanti akan ada konten utama untuk penyewa,
                  // seperti daftar kos yang tersedia, pencarian, dll.
                  ElevatedButton(
                    onPressed: () {
                      // Contoh: Navigasi ke halaman daftar kos untuk penyewa
                      // Navigator.push(context, MaterialPageRoute(builder: (context) => KosListScreen()));
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Fitur pencarian kos akan segera hadir!')),
                      );
                    },
                    child: const Text('Cari Kos Sekarang'),
                  ),
                ],
              ),
      ),
